...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div class="bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="margin-top: 50px; font-family:'Urbanist'; padding-bottom: 20px;">
        <h1 style="font-size: 30px; margin-bottom: 10px">Overview</h1>
    ...
    <div class="bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" style="margin-top: 50px; font-family:'Urbanist'; padding-bottom: 20px;">
        <h1 style="font-size: 30px; margin-bottom: 10px">Saving your Study Guide</h1>
        <p style="font-size: 20px">
